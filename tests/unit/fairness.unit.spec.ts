 ...
 *
 * Базлайн (2026-07-03, SH-12 фикс. поле + SH-13 молниевая звезда, seed 0, N=80): все
 * ландшафты байт-идентичны (93.6), все портреты (93.9) — миров всего два; разброс по всем
 * 16 профилям 0.4% (остаточная разница форм 16:9 vs 9:16; звезда orientation-fair: CRN даёт
 * один и тот же roll/момент/ОТНОСИТЕЛЬНУЮ позицию на всех профилях). История: кламп 2:1 —
 * 5.5%; SH-12 без звезды — 0.8%. Пороги 5/3 — ловят РЕАЛЬНЫЙ перекос баланса, не шум.
 */
