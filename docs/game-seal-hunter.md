...
* **Низ (портрет/4:3):** **песчаное дно** — градиент **от цвета дна арены** (бесшовный стык, не резкая
  линия) к песку, плюс мягкие дюны у стыка → вода переходит в песок как единый ландшафт; рябь песка,
  галька, **коряги**, валуны, качающаяся травка.
