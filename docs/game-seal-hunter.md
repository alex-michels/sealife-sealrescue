...
**Ключевой инвариант:** при наличии поверхности рыбы **не пересекают ватерлинию** (мягкий клэмп в
`updatePrey`) и не спавнятся сверху — из воздуха ничего не падает. Без поверхности (широкий экран) верх —
