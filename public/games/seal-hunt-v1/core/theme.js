...
export const PALETTE = {
  ...
  // — Тюлень: тёплый pebble, светлый живот, ink-детали, fog-усы
  seal: {
    back: '#75695A', // тёмный pebble (спина/тень) — больше контраста
    body: PEBBLE, // основной
    belly: '#CBBFAB', // живот (теплее, не уходит в белый)
    rim: '#CFC4B3', // мягкий контровой блик
    spot: 'rgba(110,98,82,0.5)', // крап на шкуре (тонкий)
    dark: INK, // глаз, нос, кончики ласт
    whisker: 'rgba(237,241,243,0.85)',
    shadow: 'rgba(8,20,28,0.28)',
  },
