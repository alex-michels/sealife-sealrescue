const STRINGS = {
  en: {
    ...
    route: 'Route',
    relaxed: 'Gentle pace',
    practiceTempo: 'Practice pace',
    tempoSteady: 'Slow, steady current',
    tempoStandard: 'Standard · 100%',
    tempoHint:
      'Steady slows the whole game to keep the current even, including during bursts. Percentages slow the whole game but keep its accelerations. Energy and timers slow together. Weekly uses standard pace.',
    how: 'How to swim',
    ...
    howHazards:
      'Dive below boat propellers and dodge predators. Nets drag you back while the current keeps moving. Solid rocks push you away.',
    howBurst:
    ...
    backgroundCalm: 'Calm',
    backgroundRich: 'Rich',
    backgroundMinimum: 'Minimum motion',
    backgroundHint: 'Background only. Swimming speed and difficulty stay the same.',
    on: 'On',
    off: 'Off',
  ...
  ru: {
    ...
    practiceTempo: 'Темп тренировки',
    tempoSteady: 'Медленно и ровно',
    tempoStandard: 'Обычный · 100%',
    tempoHint:
      'Ровный темп замедляет всю игру, сохраняя постоянное течение даже при рывке. Проценты замедляют игру, сохраняя её разгоны. Энергия и таймеры замедляются вместе. В экспедиции недели — обычный темп.',
    how: 'Как плыть',
    ...
    howHazards:
      'Ныряй ниже лодочных винтов и уворачивайся от хищников. Сети тянут назад, течение продолжается. Камни отбрасывают.',
    ...
    backgroundRich: 'Насыщенный',
    backgroundMinimum: 'Минимум движения',
    backgroundHint: 'Только оформление. Скорость заплыва и сложность сохраняются.',
    on: 'Вкл.',
    off: 'Выкл.',
    ...
    firstMove: 'Веди пальцем или нажимай ↑ ↓',
