...
export async function generateMetadata({
  ...
  return {
    title: legalDocs.privacy[locale as RouteLocale].title,
    alternates: buildLegalAlternates('/privacy', locale as RouteLocale, sites[site]),
  }
}
...
export default async function PrivacyPage({
  ...
  return (
    <LegalArticle doc={legalDocs.privacy[locale as RouteLocale]} lang={locale as RouteLocale} />
  )
}
