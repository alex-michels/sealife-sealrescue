...
export const sampleArticles: SampleDoc[] = [
  {
    slug: 'sample-article',
    title: lorem('Почему тюлени плачут (спойлер: не от грусти)', 'Why seals “cry” (spoiler: not from sadness)'),
    excerpt: lorem(
  ...
  },
  {
    ...
    excerpt: lorem('Полушарный сон и «бутылкование» столбиком.', 'Hemispheric sleep and vertical “bottling”.'),
    date: '2026-05-28',
    readMin: 4,
    aiAssisted: false,
...
export const sampleNews: SampleDoc[] = [
  {
    slug: 'sample-news',
    title: lorem('Центр на Балтике выпустил пять тюленят', 'A Baltic center released five seal pups'),
    excerpt: lorem('После реабилитации малышей вернули в море.', 'After rehab, the pups were returned to the sea.'),
    date: '2026-06-18',
    readMin: 2,
    aiAssisted: false,
...
export const sampleMemes: SampleMeme[] = [
  { slug: 'blep', caption: lorem('Когда показал язык и не жалеешь', 'When you blep and regret nothing'), seed: 1 },
  { slug: 'monday-seal', caption: lorem('Я в понедельник', 'Me on a Monday'), seed: 2 },
  { slug: 'snack-time', caption: lorem('Услышал шелест пакета с рыбой', 'Heard the fish bag rustle'), seed: 3 },
  { slug: 'banana-pose', caption: lorem('Поза банан — это лук, а не лень', 'The banana pose is a look, not laziness'), seed: 4 },
]
...
export const sampleQuizzes: SampleQuiz[] = [
  ...
  },
  {
    ...
    questions: 8,
    sample: {
      q: lorem('Тюленю нужно помочь вернуться в воду.', 'A seal needs help getting back to the water.'),
...
export const sampleSpecies: SampleSpecies[] = [
  {
    ...
    size: '≈ 1.3 м',
    excerpt: lorem('Маленькая нерпа с «кольцами» на шкуре.', 'A small seal with “rings” on its coat.'),
    facts: [
  ...
  },
  {
    ...
    size: '≈ 2 м',
    excerpt: lorem('«Лошадиная морда» — буквально из латыни.', 'The “hook-nosed sea pig”, literally from Latin.'),
  ...
  },
  {
    ...
    size: '≈ 1.7 м',
    excerpt: lorem('Тот самый «улыбающийся» тюлень с пятнами.', 'The classic spotted, “smiling” seal.'),
...
export const sampleCenters: SampleCenter[] = [
  ...
  },
  {
    ...
    summary: lorem('Образец: данные требуют проверки человеком.', 'Sample: data awaits human verification.'),
  },
  {
    ...
    summary: lorem('Образец активного центра с маршрутом и телефоном.', 'Sample active center with directions and phone.'),
  },
  {
    ...
    summary: lorem('Образец: ссылка на сайт центра не открывается.', 'Sample: the center’s website link is broken.'),
  },
]
...
export const sampleRescueNews: SampleDoc[] = [
  {
    ...
    excerpt: lorem('Несколько центров изменили часы работы.', 'A few centers changed their opening hours.'),
    date: '2026-06-15',
    readMin: 2,
    aiAssisted: false,
