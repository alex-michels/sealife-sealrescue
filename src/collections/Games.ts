...
export const Games: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      // пуш схемы ничего внезапно не гасит ни в одном окружении, ни в CI.
      name: 'standaloneComingSoon',
      type: 'checkbox',
      defaultValue: false,
      admin: {
        description:
          'Standalone-заглушка «Coming soon»: ВКЛ — прямой URL игры (или её vanity-поддомен ' +
          'вида *.sealife.info) показывает атмосферный фон без игры и надпись «Coming soon». ' +
          'ВЫКЛ (по умолчанию) — игра доступна как обычно. ' +
          'НЕ влияет на iframe-встраивание на sealife.info. ' +
