...
export const contentSeed: ContentSeed[] = [
  ...
  },
  {
    ...
    body: {
      ru: [
        'Тюлени умеют спать, держа одно полушарие мозга бодрствующим, и зависать «столбиком» у поверхности — это называют бутылкованием.',
      ],
      en: [
        'Seals can sleep with one brain hemisphere awake and hang vertically near the surface — a posture called bottling.',
      ],    },
  },
  {
    type: 'article',
  ...
  },
  {
    ...
    body: {
      ru: [
        'Волонтёры зафиксировали новое лежбище и просят держаться поодаль — особенно в сезон линьки, когда тюлени особенно уязвимы.',
      ],
      en: [
        'Volunteers recorded a new rookery and ask people to keep their distance — especially during moulting season, when seals are most vulnerable.',
      ],    },
  },
  {
    type: 'meme',
...
export const speciesSeed: SpeciesSeed[] = [
  {
    ...
    facts: [
      {
        ru: 'Делает снежные норы для детёнышей.',
        en: 'Builds snow lairs for its pups.',      },
      {
        ru: 'Под угрозой из-за таяния льда.',
        en: 'Threatened by shrinking ice.',      },
    ],
    body: {
      ru: [
  ...
  },
  {
    ...
    body: {
      ru: [
        'Серый тюлень — один из крупнейших хищников Балтики; узнаётся по вытянутой «лошадиной» морде.',
      ],
      en: [
        'The grey seal is one of the Baltic’s largest predators, recognised by its long “horse-like” muzzle.',
      ],    },
  },
  {
    slug: 'harbour-seal',
