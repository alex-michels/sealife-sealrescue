...
export const sectionDefs: SectionDef[] = [
  ...
  },
  {
    ...
    intro: { ru: 'Галерея тюленьего юмора.', en: 'A gallery of seal humour.' },
  },
  {
    slug: 'quizzes',
    site: 'sealife',
    ...
    intro: { ru: 'Проверь, насколько ты тюлень.', en: 'Find out how much of a seal you are.' },
  },
  {
    slug: 'games',
    site: 'sealife',
    ...
    intro: { ru: 'Маленькие игры про тюленей и море.', en: 'Small games about seals and the sea.' },
  },
  {
    slug: 'species',
    site: 'sealife',
    ...
    intro: { ru: 'Виды ластоногих: кто есть кто.', en: 'Pinniped species: who’s who.' },
  },
  ...
  // — sealrescue (справочник спасения) —
  {
    ...
    title: { ru: 'Нашёл тюленя — что делать', en: 'Found a seal — what to do' },
    intro: { ru: 'Спокойно. Несколько простых шагов.', en: 'Stay calm. A few simple steps.' },
  },
  {
    slug: 'rescue-centers',
    site: 'sealrescue',
  ...
  },
  {
    ...
    title: { ru: 'Что делать, если нашёл тюленя?', en: 'What to do if you found a seal?' },
    intro: {
